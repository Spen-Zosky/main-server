# CLAUDE.md - Main Server Platform Universal Clean Architecture
...
#### 🌐 Language & Localization Standardization
...
#### 🔧 Professional Dual Environment Implementation
...
### ENHANCED CHAIN OF THOUGHT (CoT) DECISION PROCESS

All team members must adopt a structured Chain of Thought (CoT) to ensure rigor, consistency, and accountability in every decision or action taken in the project.

#### The process consists of 8 key steps:

| Step | Guiding Question | Objective | Agent-Specific Examples |
|------|------------------|-----------|----------------------|
| **1. Context** | What is the operational context in which I am intervening? | Frame level, environment, constraints | **Solution Architect:** System design for production scaling, not prototyping<br>**Fullstack Developer:** Feature integration across frontend + backend<br>**Data Architect:** Database optimization in production environment<br>**Backend Developer:** API modification in microservices architecture<br>**Frontend Developer:** Component update in shared design system |
| **2. Objective** | What is the precise purpose of my action? | Align intervention to concrete objective | **Solution Architect:** Design scalable architecture for 10x user growth<br>**Fullstack Developer:** Implement end-to-end user authentication system<br>**Data Architect:** Optimize database queries for 50% performance improvement<br>**Backend Developer:** Refactor API endpoints for better maintainability<br>**Frontend Developer:** Create reusable component library |
| **3. Relevance** | Why is it important to do it now? Is it a priority? | Evaluate urgency, impact, roadmap coherence | **Solution Architect:** Architecture decision blocks team progress<br>**Fullstack Developer:** Security vulnerability requires immediate fix<br>**Data Architect:** Database performance affects user experience<br>**Backend Developer:** API change required for frontend feature release<br>**Frontend Developer:** User complaints about interface usability |
| **4. Impacts** | Who or what will be influenced by my decision? | Consider effects on code, data, users | **Solution Architect:** All development teams, system scalability, technical debt<br>**Fullstack Developer:** Frontend/backend teams, user authentication flow<br>**Data Architect:** Database performance, data consistency, backup systems<br>**Backend Developer:** API consumers, data integrity, system reliability<br>**Frontend Developer:** User interface, accessibility, mobile compatibility |
| **5. Alternatives** | Are there different options? What are trade-offs? | Evaluate solutions, costs/benefits | **Solution Architect:** Microservices vs monolith - complexity vs performance<br>**Fullstack Developer:** JWT vs session tokens - scalability vs simplicity<br>**Data Architect:** SQL vs NoSQL - consistency vs flexibility<br>**Backend Developer:** REST vs GraphQL - simplicity vs query flexibility<br>**Frontend Developer:** React vs Vue - ecosystem vs learning curve |
| **6. Evidence** | Do I have objective elements to decide? Have I verified? | Base action on data, logs, tests | **Solution Architect:** Performance benchmarks, load testing results, architecture reviews<br>**Fullstack Developer:** Code coverage reports, integration test results, security scans<br>**Data Architect:** Query performance metrics, storage utilization, backup success rates<br>**Backend Developer:** API response times, error logs, database performance<br>**Frontend Developer:** User analytics, accessibility audits, cross-browser testing |
| **7. Communication** | Do I need to inform or coordinate with others? | Ensure transparency and collaboration | **Solution Architect:** Notify all tech leads, update architecture board<br>**Fullstack Developer:** Coordinate with frontend/backend teams, update stakeholders<br>**Data Architect:** Inform DBA team, coordinate with backend developers<br>**Backend Developer:** Notify API consumers, coordinate with frontend team<br>**Frontend Developer:** Update design system team, inform QA testers |
| **8. Documentation** | Do I need to record the action? Where and how? | Ensure auditability and knowledge sharing | **Solution Architect:** Update architecture decision records (ADRs)<br>**Fullstack Developer:** Update README, create migration guides<br>**Data Architect:** Document schema changes, update data dictionary<br>**Backend Developer:** Update API documentation, create changelog entries<br>**Frontend Developer:** Update component documentation, create style guides |
...
### Project Mission
Universal enterprise platform with **ZERO hardcoded paths** - deploys anywhere, runs everywhere. Complete PathResolver integration eliminates environment coupling and enables bullet-proof deployment portability.

### Universal Deployment Capabilities
**Deploy to ANY environment with ZERO configuration:**
- **Cloud Platforms**: AWS, GCP, Azure, Heroku, Railway, Vercel
- **Containers**: Docker, Kubernetes, any container orchestration  
- **Servers**: Any Linux, macOS, Windows, or Unix system
- **Local Dev**: Any development workstation or environment
...
**Use `npm run mcp:status` to view real-time ecosystem status**
